    ...
    launch_robot_include = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            PathJoinSubstitution(
                [FindPackageShare("echoboat_project11"), "launch", "echo_launch.py"]
            )
        ),
    ...
    operator_group = GroupAction(
        actions=[
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    PathJoinSubstitution(
                        [FindPackageShare("project11"), "launch", "operator_core_launch.py"]
                    )
                ),
                launch_arguments={
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    PathJoinSubstitution(
                        [FindPackageShare("project11"), "launch", "operator_ui_launch.py"]
                    )
                ),
                launch_arguments={
...
#     <rosparam param="udp_bridge/remotes/operator/connections/default/port" ns="$(arg namespace)" subst_value="True">4201</rosparam>  # noqa: E501
#     <rosparam param="udp_bridge/remotes/operator/connections/default/host" ns="$(arg namespace)" subst_value="True">localhost</rosparam>  # noqa: E501
#   </group>
# </launch>
